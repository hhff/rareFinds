<?php
    ...
    if (version_compare(PHP_VERSION, '5.2.0', '<')) {
        $fail = true;
        $reasons[] = "Perch 2 requires PHP 5.2 or greater. You have PHP ".PHP_VERSION.". <br />Any good hosting company should be able to update your account to a more recent version of PHP.";
    }
